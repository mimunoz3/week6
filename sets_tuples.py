...
# print("apple" in set2) #ouputtrue
# print("banana" in set3) #ouput:true
# #you cannot acccess elements in a set by index because sets are unordered, instead you can convert the set to a list and acess elements by index
# #we use sets when we do not care about the order of the elements and do not want the elements to be changed 
...
budget1 = print(company["departments"]["Engineering"]["budget"]) 
budget2 = print(company["departments"]["HR"]["budget"]) 
